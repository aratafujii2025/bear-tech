//add this to specify that its a client side page
'use client';
...
{/* STARTS HERE */}
        ...
        <input type="submit" onClick={() =>{ //submit button
          ...
          const intended_text = document.getElementById("text");
          console.log(intended_text);

          const params = new FormData();
          const selectDom = document.getElementById("file").files[0];
          if(selectDom == null){
            console.log("empty");
          }

          params.append('file', selectDom);
